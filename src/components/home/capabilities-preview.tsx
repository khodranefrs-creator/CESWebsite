            ...
            return (
              <Inview key={cap.id} delay={i * 70}>
                <Link
                  ...
                  className="group grid grid-cols-[auto_1fr_auto] items-center gap-x-6 border-b border-line py-7 sm:grid-cols-[3.5rem_1fr_1fr_auto] sm:gap-x-10 md:py-9"
                >
                  ...
                  <span className="flex items-center gap-5 md:gap-7">
                    ...
                    <span className="type-display-m !text-[clamp(1.35rem,1.1rem+1.4vw,2.4rem)] font-semibold leading-none tracking-tight transition-all duration-300 group-hover:translate-x-2 group-hover:text-accent">
                      {cap.name}
                    </span>
                  </span>
