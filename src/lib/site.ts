export const company = {
  ...
  conceptLine: "Precision connects what’s next",
...
/* ------------------------------------------------------------------ */
/* Industries — names and framing only; no invented specifics          */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/* Differentiators — supplied positioning only                         */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/* Engineering-to-production journey                                   */
/* ------------------------------------------------------------------ */
